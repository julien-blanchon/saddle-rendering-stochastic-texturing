...
use stochastic_texturing::StochasticTexturingSystems;

use crate::scenarios;

pub struct StochasticTexturingLabE2EPlugin;

impl Plugin for StochasticTexturingLabE2EPlugin {
    fn build(&self, app: &mut App) {
        app.add_plugins(saddle_bevy_e2e::E2EPlugin);
        app.configure_sets(Update, E2ESet.before(StochasticTexturingSystems::Prepare));
